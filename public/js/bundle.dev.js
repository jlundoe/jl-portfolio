(() => {
  ...
  // ns-hugo-imp:/Users/jakoblundoe/Local Files/Repos/jl-portfolio/assets/js/modules/tabs.js
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const videoPlayers = import_plyr.default.setup(".plyr-video", {
    ...
    const audioPlayers = import_plyr.default.setup(".plyr-audio", {
      volume: 0.8,
      seekTime: 10,
